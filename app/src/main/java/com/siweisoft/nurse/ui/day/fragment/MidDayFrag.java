...
public class MidDayFrag extends BaseNurseFragWithoutTitle<MidDayUIOpe,BaseNetOpe,BaseDBOpe,BaseDAOpe>{
    ...
    @Override
    public BaseNurseOpes<MidDayUIOpe, BaseNetOpe, BaseDBOpe, BaseDAOpe> getOpe() {
        if(baseNurseOpes==null){
            baseNurseOpes = new BaseNurseOpes(new MidDayUIOpe(activity,getView()),null,null,null);
        }
